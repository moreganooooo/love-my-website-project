...
const Projects = () => {
  ...
  return (
    <section id="projects" className="py-20 px-6 bg-gradient-to-br from-slate-50 via-purple-50 to-orange-50 relative overflow-hidden">
      {/* Background effects */}
      <div className="absolute inset-0">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-gradient-to-br from-orange-200/20 to-purple-200/20 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-gradient-to-tl from-purple-200/20 to-orange-200/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
      </div>
            ...
            >
              ...
              <CardContent className="p-6">
                ...
                <div className="flex gap-3">
                  <Button variant="outline" size="sm" className="flex-1 border-orange-200 hover:bg-orange-50 hover:border-orange-300 transition-all duration-300">
                    <Github className="h-4 w-4 mr-2" />
                    Details
                  </Button>
                  <Button size="sm" className="flex-1 bg-gradient-to-r from-orange-500 to-purple-600 hover:from-orange-600 hover:to-purple-700 shadow-lg hover:shadow-xl transition-all duration-300">
