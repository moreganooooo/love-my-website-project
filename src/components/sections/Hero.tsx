...
const Hero = () => {
  ...
  return (
    <section className="min-h-[90dvh] flex items-center justify-center px-4 sm:px-6 md:px-10 lg:px-16 xl:px-24 pt-16 md:pt-20 lg:pt-24 pb-12 md:pb-16 lg:pb-20 relative bg-gradient-to-br from-orange-400 via-orange-500 to-purple-700 overflow-hidden">
      ...
      <div className="flex items-center justify-center min-h-[50dvh] w-full">
        <div className="text-center z-10 w-full max-w-screen-md sm:max-w-screen-lg md:max-w-screen-xl mx-auto animate-fade-up px-4 sm:px-6 md:px-10">
          <div className="flex flex-col justify-center items-center min-h-[50dvh] space-y-8 md:space-y-10">
