  ...
  <section className="py-20 px-6 bg-gradient-to-br from-purple-800 via-purple-700 to-orange-600 text-white relative overflow-hidden">
    ...
    <div className="max-w-6xl mx-auto relative z-10">
      <div className="text-center mb-16">
        <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white drop-shadow-lg">Contact</h2>
      ...
      <div className="grid lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-6">
          ...
          {contactInfo.map(info => (
            <Card
              key={info.title}
              className="bg-white/10 border-white/20 backdrop-blur-md hover:bg-white/20 transition-all duration-500 hover:scale-105"
            >
