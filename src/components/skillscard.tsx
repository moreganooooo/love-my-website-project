...
const SkillCard = ({ skill, index }: SkillCardProps) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "group p-[2px] rounded-2xl bg-gradient-to-br from-orange-400 via-purple-400 to-orange-200 bg-[length:200%_200%] bg-[position:0%_0%] transition-all duration-500 hover:bg-[position:100%_100%]",
