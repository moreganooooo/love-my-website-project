  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-6 relative overflow-hidden bg-gradient-to-br from-orange-400 via-orange-500 to-purple-700">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        {/* Dynamic swirling texture elements */}
        <div className="absolute inset-0">
          <svg className="absolute inset-0 w-full h-full opacity-30" viewBox="0 0 1000 1000" preserveAspectRatio="none">
            ...
            <path d="M0,300 Q250,100 500,300 T1000,300 L1000,1000 L0,1000 Z" fill="url(#swirl1)" className="animate-pulse">
              <animateTransform attributeName="transform" type="translate" values="0,0; 50,20; 0,0" dur="8s" repeatCount="indefinite"/>
            </path>
            <path d="M0,600 Q300,400 600,600 T1200,600 L1200,1000 L0,1000 Z" fill="url(#swirl2)" className="animate-pulse delay-500">
            ...
            <circle cx="200" cy="200" r="100" fill="rgba(255,255,255,0.1)" className="animate-pulse">
              <animateTransform attributeName="transform" type="translate" values="0,0; 100,50; 0,0" dur="12s" repeatCount="indefinite"/>
            </circle>
            <circle cx="800" cy="700" r="80" fill="rgba(255,200,150,0.15)" className="animate-pulse delay-700">
              <animateTransform attributeName="transform" type="translate" values="0,0; -80,30; 0,0" dur="9s" repeatCount="indefinite"/>
            </circle>
          </svg>
        </div>
      ...
      <div className="text-center z-10 max-w-5xl mx-auto animate-fade-in">
        <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold mb-6 bg-gradient-to-r from-white via-orange-100 to-white bg-clip-text text-transparent drop-shadow-2xl leading-tight">
          Hi, I'm Morgan.
        </h1>
