      ...
      <section className="min-h-screen flex items-center justify-center px-6 relative bg-gradient-to-br from-orange-400 via-orange-500 to-purple-700">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="text-center z-10 max-w-4xl mx-auto animate-fade-in">
            <div className="flex flex-col justify-center items-center min-h-[40vh] space-y-3 pb-2 pt-4">
              <h1 className="relative z-10 text-3xl sm:text-4xl md:text-6xl lg:text-6xl xl:text-7xl font-bold mb-1 bg-gradient-to-r from-white via-orange-100 to-white bg-clip-text text-transparent drop-shadow-2xl leading-[1.3] px-4 py-4 overflow-visible">
                Hi, I'm Morgan.
              </h1>
