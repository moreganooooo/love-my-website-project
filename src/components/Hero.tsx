        ...
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center z-10 max-w-4xl mx-auto animate-fade-up px-4 sm:px-6 md:px-10">
            <div className="flex flex-col justify-center items-center min-h-[80vh] space-y-6">
              <h1 className="relative z-10 text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-1 font-playfair bg-gradient-to-r from-white via-orange-100 to-white bg-clip-text text-transparent drop-shadow-2xl leading-[1.3] px-4 py-2 overflow-visible animate-fade-up delay-200">
                Hi, I'm Morgan.
              </h1>
              <p className="text-lg sm:text-xl md:text-2xl text-white/90 mb-4 max-w-[75ch] mx-auto leading-snug drop-shadow-lg mt-0 font-source animate-fade-up delay-500">
