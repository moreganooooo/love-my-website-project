          ...
          <div className="text-center z-10 max-w-4xl mx-auto animate-fade-up">
            <div className="flex flex-col justify-center items-center min-h-[80vh] space-y-6">
              ...
              <Button
                ...
                size="lg"
                className="bg-white/20 hover:bg-white/30 text-white px-8 py-6 text-lg rounded-full shadow-2xl hover:shadow-3xl transition-all duration-500 backdrop-blur-md border border-white/30 hover:border-white/50 mt-2 animate-fade-up delay-1000"
              >
                CONTACT ME
